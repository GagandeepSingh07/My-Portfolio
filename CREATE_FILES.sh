#!/bin/bash
# Portfolio Migration Script - Complete Automation
# This script creates all new files with proper content

echo "========================================="
echo "Creating global.css..."
echo "========================================="

cat > "src/css/global.css" << 'EOF'
...
echo "global.css created successfully!"
echo ""
echo "Migration complete!"
echo "Next: Run MIGRATE.bat to copy all files"
