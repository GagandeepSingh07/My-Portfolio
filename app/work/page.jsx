    ...
    <>
      ...
      <main className="px-4">
        ...
        <section className="flex flex-col items-center mt-32">
          ...
          >
            <p>Browse My Work</p>
            <button className="btn glass py-1 px-3 text-xs">Portfolio</button>
          </motion.div>
          ...
          >
            A showcase of my graphic design, motion graphics, video editing, and
            creative projects. Each piece tells a unique story and demonstrates
            my passion for visual excellence.
          </motion.p>
        </section>
