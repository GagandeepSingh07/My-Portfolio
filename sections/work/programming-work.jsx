    ...
    projects: [
      {
        ...
        description:
          "Full-featured online shopping platform with cart and checkout",
  ...
  return (
    <section className="max-w-5xl mx-auto mt-32">
      ...
      >
        ...
        <p className="mt-4 text-gray-100 text-sm max-w-md mx-auto">
          Web development projects showcasing modern technologies and best
          practices
        </p>
      </motion.div>
